...
# Clear potential environment conflicts
unset PYTHONHOME
unset PYTHONPATH

echo "--- 🚀 STARTING ADVANCED RTX 5090 PRODUCTION SETUP ---"

# 1. SYSTEM DEPENDENCIES
apt-get update && apt-get install -y \
    git build-essential python3-dev wget aria2 screen \
...
# Fixed indentation and standard spacing for aria2c
...
aria2c -i download_list.txt -j 16 -x 16 -s 16 --console-log-level=error &
DOWNLOAD_PID=$!
...
echo "Installing Node Dependencies (Safety Filter Applied)..."
