...
WORKSPACE_SCRIPTS=(
    ...
    "https://raw.githubusercontent.com/aster-king/Vast-AI-Comfy/refs/heads/main/scail.sh"
)
...
function provisioning_start() {
    ...
    # STEP 2: Download start.sh & scail.sh (files serve as their own markers)
...
function provisioning_download_workspace_scripts() {
    ...
    chmod +x "${WORKSPACE}/scail.sh"
    printf "Scripts made executable: start.sh, scail.sh\n"
}
